...
## 느낀점
지난번 과제에 비해 그나마 수월하게 생각하고 할 수 있었던 것 같습니다! 하지만 아직도 어려운점은 가득하네요..
처음에는 배열을 이용하려했으나 자꾸 오류가 떠서 아직 저에겐 많이 낯선 리스트를 이용하여 검색을 좀 많이하면서 새롭게 다시 공부하는 계기도 되었던 것 같습니다!
마지막에 출력까지 완성했지만 ,를 이용하여 결과를 출력할 때 더 간결하게 나타낼 방법을 원했지만 마땅히 떠오르지않아 우승자 목록을 문자열로 변환하여 출력하였습니다. 
아직 모르는게 많아서 많은 지적 부탁드립니다!!
